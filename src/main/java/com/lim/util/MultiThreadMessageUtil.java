 ...
 * @author qinhao
 */
public class MultiThreadMessageUtil {

    private static final Logger logger = LoggerFactory.getLogger(MultiThreadMessageUtil.class);
     ...
     * @param records
     */
    public static void parse(Map<String, Rate> buffer, List<ConsumerRecord<String, String>> records) {
